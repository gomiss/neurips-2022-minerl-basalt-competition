...
class AnimalDetector():
    def __init__(self, 
        ...
        self.animal_class = ['cow', 'duck', 'pig', 'rabbit', 'sheep']
...
if __name__ == '__main__':
    IMG_PATH = './data/minecraft_test_imgs/845.jpg'
    img = cv2.imread(IMG_PATH)

    animal_detector = AnimalDetector(
        './runs/train/exp_data_flip_aug/weights/best.pt',
        './data/minecraft_original/data.yaml',
    )
