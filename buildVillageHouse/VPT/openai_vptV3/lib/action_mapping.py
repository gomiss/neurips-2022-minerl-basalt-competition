...
class ActionMapping(abc.ABC):
    ...
    BUTTONS_GROUPS_V2 = OrderedDict(
        hotbar=["none"] + [f"hotbar.{i}" for i in range(1, 10)],
        fore_back_left_right_use_drop_attack = ["none", "forward", "back", "left", "right", "drop", "attack", "jump", "use"]
    )
...
class CameraHierarchicalMapping(ActionMapping):
    ...
    def from_factored(self, ac: Dict) -> Dict:
        ...
        # print("choices_by_group:", choices_by_group)
