...
from action_mapping import CameraHierarchicalMapping
from impala_cnn import ImpalaCNN
from normalize_ewma import NormalizeEwma
...
class MinecraftPolicy(nn.Module):
    ...
    def __init__(
        ...
        **unused_kwargs,
        ...
        # self.lastlayer_2 = FanInInitReLULayer(hidsize, hidsize, layer_type="linear", **self.dense_init_norm_kwargs)
...
class MinecraftAgentPolicy(nn.Module):
    ...
    def forward(self, obs, first: th.Tensor, state_in, **extra_input):
    ...
    # def get_mesloss_of_v(self, vpred, reward):
    #     r = tree_map(lambda x: x)
