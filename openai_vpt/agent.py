...
class MineRLAgent:
    def __init__(self, env, device=None, policy_kwargs=None, pi_head_kwargs=None, use_legal_action=False):
        if device is None:
        ...
        self.action_mapper = CameraHierarchicalMapping(n_camera_bins=11, use_legal_action=use_legal_action)
    ...
    def get_action(self, minerl_obs):
        ...
        agent_action, self.hidden_state, _ = self.policy.act(
            ...
            stochastic=True, legal_action=self.action_mapper.legal_action
        )
